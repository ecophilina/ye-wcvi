...
```{r ye-ratio-through-time, fig.cap="Estimated ratio of YE biomass to landable halibut biomass through time within the CDA vs. in Area 3CD5A outside the CDA. Legend otherwise the same.", out.width="5in"}
