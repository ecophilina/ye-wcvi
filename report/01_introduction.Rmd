...
```{r halibut-preds-all, fig.cap="Observed (circle area) and predicted (colour) Halibut in the HBLL survey per 100 hooks across all years. The CDA is outlined in red. Note that the colour axis is fourth-root transformed to improve visual interpretation.", out.width="\\textwidth"}
