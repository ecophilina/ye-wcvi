...
```{r halibut-preds, fig.cap="Caption here", out.width="4in"}
...
Proportion of estimated total Halibut catch inside CDA in 2020: 
`r r2(i_hal_cda2020$est / (i_hal_cda2020$est + i_hal_noncda2020$est))`

Average estimated Halibut catch per 100 hooks inside CDA:
`r r2(i_hal_cda2020$est / nrow(cda_grid))`

Average estimated Halibut catch per 100 hooks outside CDA:
...
Average estimated YE catch per 100 hooks inside CDA:
`r r2(i_ye_cda$est / nrow(cda_grid))`

Average estimated YE catch per 100 hooks outside CDA:
