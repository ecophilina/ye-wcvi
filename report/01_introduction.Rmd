...
All values are for only those 2x2 km grid cells included in either the HBLL or trawl surveys, catch estimates are based on HBLL survey type if part of the that grid, otherwise assumed to be better represenated by the trawl survey data.
