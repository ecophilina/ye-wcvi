...
```{r region-col-key, fig.cap="This map illustrates the sub-regions for which indices will be calculated. CDA in red, area 3CD5A north of 50º in green, and area 3CD5A south of 50º but outside of the CDA in purple.", out.width="5in"}
