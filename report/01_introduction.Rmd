...
```{r halibut-indexes, fig.cap="Halibut index of relative abundance in various regions.", out.width="6in"}
include_graphics(here("figs/halibut-index-by-area.png"))
```

```{r halibut-indexes-avg, fig.cap="Average relative abundance index per HBLL grid cell in CDA vs. outside CDA.", out.width="6in"}
