...
```{r halibut-indexes, fig.cap="Halibut index of relative abundance in various regions. Lines are means and ribbons are 95\\% confidence intervals (CIs). We could do the same for YE and YE/Halibut if needed.", out.width="6in"}
