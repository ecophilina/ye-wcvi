...
* Negative binomial observation model with an 'offset' for number of hooks. This mean we're ultimately modelling fish caught per hook but with a statistical approach that lets us use a count distribution.

* Not accounting for hook competition currently (the outside YE assessment chose to ignore it after some analysis).

* We have lots of diagnostic and validation plots; they aren't included here.
