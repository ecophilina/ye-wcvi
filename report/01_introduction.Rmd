...
```{r halibut-preds-2020, fig.cap="Halibut in 2020. This is a zoomed in version of just 2020 from the previous plot.", out.width="5.5in"}
...
```{r ye-per-hal-preds-2020, fig.cap="YE per Halibut in 2020. Not that the circles represent the number of halibut caught and so are a different data type from the predictions.", out.width="5.5in"}
...
```{r halibut-indexes-avg, fig.cap="Average Halibut relative abundance per HBLL grid cell in CDA vs. in area 3CD but outside CDA.", out.width="6in"}
...
Proportion of estimated total Halibut in **Area 3CD** expected to be inside CDA in 2020: 
