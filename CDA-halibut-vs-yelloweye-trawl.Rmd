...
ggsave("figs/hybrid-halibut-hbllyrs-AR1-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
.dat <- bind_rows(mutate(i_hal, Model = "HBLL (counts)", Species = "Halibut"),
  mutate(i_hal_hbll, Model = "HBLL + trawl (biomass)", Species = "Halibut"),
  mutate(i_ye, Model = "HBLL (counts)", Species = "Yelloweye"),
  mutate(i_ye_hbll, Model = "HBLL + trawl (biomass)",  Species = "Yelloweye")
)
