...
g_1 <- readRDS(paste0("data-generated/filled", model_type, "-halibut", model_vars, "-index-3C-sim-500.rds"))[[3]] %>% filter(region %in% c("3C")) %>% select(X, Y, year, area)
g_2 <- readRDS(paste0("data-generated/filled", model_type, "-halibut", model_vars, "-index-3D-sim-500.rds"))[[3]] %>% filter(region %in% c("3D")) %>% select(X, Y, year, area)
g_3 <- readRDS(paste0("data-generated/filled", model_type, "-halibut", model_vars, "-index-5A-sim-500.rds"))[[3]] %>% filter(region %in% c("5A")) %>% select(X, Y, year, area)
g_4 <- readRDS(paste0("data-generated/filled", model_type, "-halibut", model_vars, "-index-5B-sim-500.rds"))[[3]] %>% filter(region %in% c("5B")) %>% select(X, Y, year, area)
...
s_hal_3 <- readRDS(paste0("data-generated/filled", model_type, "-halibut", model_vars, "-index-5A-sim-500.rds"))[[4]][,1:100]
s_hal_4 <- readRDS(paste0("data-generated/filled", model_type, "-halibut", model_vars, "-index-5B-sim-500.rds"))[[4]][,1:100]

model_vars <- "-est-rock-mud" # YE

s_ye_1 <- readRDS(paste0("data-generated/filled", model_type, "-yelloweye", model_vars, "-index-3C-sim-500.rds"))[[4]][,1:100]
s_ye_2 <- readRDS(paste0("data-generated/filled", model_type, "-yelloweye", model_vars, "-index-3D-sim-500.rds"))[[4]][,1:100]
s_ye_3 <- readRDS(paste0("data-generated/filled", model_type, "-yelloweye", model_vars, "-index-5A-sim-500.rds"))[[4]][,1:100]
s_ye_4 <- readRDS(paste0("data-generated/filled", model_type, "-yelloweye", model_vars, "-index-5B-sim-500.rds"))[[4]][,1:100]

model_vars <- "-delta-est-rock-mud" # change back to halibut/ version

s_hal_1 <- bind_cols(g_1, as.data.frame(s_hal_1)) %>% filter(area == 400) %>% select(-area)
s_hal_2 <- bind_cols(g_2, as.data.frame(s_hal_2))%>% filter(area == 400) %>% select(-area)
s_hal_3 <- bind_cols(g_3, as.data.frame(s_hal_3))%>% filter(area == 400) %>% select(-area)
s_hal_4 <- bind_cols(g_4, as.data.frame(s_hal_4))%>% filter(area == 400) %>% select(-area)

s_ye_1 <- bind_cols(g_1, as.data.frame(s_ye_1)) %>% filter(area == 400) %>% select(-area)
s_ye_2 <- bind_cols(g_2, as.data.frame(s_ye_2))%>% filter(area == 400) %>% select(-area)
s_ye_3 <- bind_cols(g_3, as.data.frame(s_ye_3))%>% filter(area == 400) %>% select(-area)
s_ye_4 <- bind_cols(g_4, as.data.frame(s_ye_4))%>% filter(area == 400) %>% select(-area)

.s_ye <- bind_rows(
  mutate(s_ye_1, Area = "3C"),
  mutate(s_ye_2, Area = "3D"),
  mutate(s_ye_3, Area = "5A"),
  mutate(s_ye_4, Area = "5B")
) %>% pivot_longer(cols = starts_with("V"),
  names_to = ".iteration", values_to = "ye_est")

.s_hal <- bind_rows(
  mutate(s_hal_1, Area = "3C"),
  mutate(s_hal_2, Area = "3D"),
  mutate(s_hal_3, Area = "5A"),
...
g2 <- g_2 %>% filter(area == 400) %>% select(-area)
g3 <- g_3 %>% filter(area == 400) %>% select(-area)
g4 <- g_4 %>% filter(area == 400) %>% select(-area)
...
ggsave(paste0("figs/expected_YE_when_avoiding_YE_CI", model_type, "_regions.png"), width = 6.5, height = 3.5)
...
ggsave(paste0("figs/expected_hal_when_avoiding_YE_CI", model_type, "_regions.png"), width = 6.5, height = 3.5)
...
ggsave(paste0("figs/expected_YE_when_maximize_hal_CI", model_type, "_regions.png"), width = 6.5, height = 3.5)
...
ggsave(paste0("figs/expected_hal_when_maximize_hal_CI", model_type, "_regions.png"), width = 6.5, height = 3.5)
...
ggsave(paste0("figs/expected_ye_to_hal", model_type, "_both_scenarios_regions.png"), width = 5.5, height = 3)
