...
g + theme(legend.position = c(0.35, 0), legend.justification = c(0,0)) #haven't tested yet as slow!

ggsave("figs/halibut-predictions-S3.png", width = 9, height = 10, dpi = 200)
```
...
g + theme(legend.position = c(0.35, 0), legend.justification = c(0,0)) #haven't tested yet as slow!
ggsave("figs/ye-predictions-S3.png", width = 9, height = 10, dpi = 200)
```
