...
i_ye_5A <- readRDS("data-generated/yelloweye-spatial-index-5A.rds")
...
print("Average estimated catch per 100 hooks inside CDA:")
round(i_ye_cda$est / nrow(cda_grid), 2)

print("Average estimated catch per 100 hooks outside CDA:")
round(i_ye_noncda$est / nrow(noncda_grid), 2)
```
...
```{r echo=F}
print("What proportion of estimated total catch is inside CDA in 2020?")
round(i_ye_cda$est / (i_ye_cda$est + i_ye_noncda$est + i_ye_5A$est), 2)

print("Average estimated catch per 100 hooks inside CDA:")
round(i_ye_cda$est / nrow(cda_grid), 2)

print("Average estimated catch per 100 hooks outside CDA:")
round((i_ye_noncda$est + i_ye_5A$est)/(nrow(noncda_grid)+nrow(s_5A_grid)),2)
```
# Maps
