...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/yelloweye-predictions-S.png", width = 5.5, height = 6)
```
...
g <- map_predictions(
  ...
  obs_data = filter(d_hal, year == 2020),
  fill_var = "ye_per_hal", fill_lab = "Predicted Yelloweye \nper Halibut",
  size_aes = (catch_count / hook_count) * 100,
...
dir.create("figs", showWarnings = FALSE)
ggsave("figs/ye-per-halibut-w-hal-catch-S.png", width = 5.5, height = 6)
```
