...
coast_gshhg_proj <- sf::st_transform(coast_gshhg, crs = 3156)

focal_area <- sf::st_read(dsn = "shape-files/taaqwiihak_areaVer2.shp", layer = "taaqwiihak_areaVer2")
# focal_area <- sf::st_transform(focal_area, crs = 4326)
# focal_area <- sf::st_transform(focal_area, crs = 3156)
...
gh <- ggplot(focal_area_proj) +
  ...
  xlab("Longitude") +
  ylab("Latitude") + # remove axis labels
  ggtitle("HBLL Pacific Halibut") +
...
ggsave("figs/halibut-2020-predictions-S.png", width = 5.5, height = 6)
```
