...
# ghal <- ggplot(i_hal_2020) + geom_histogram(aes(.value/num_cells, fill = Area)) + 
...
# gye <- ggplot(i_ye_2020) + geom_histogram(aes(.value/num_cells, fill = Area)) + 
...
```{r message=F, echo=F}
ggplot(i_hal_2020) + geom_histogram(aes(.value/num_cells), alpha = 0.5, fill = "black") + 
  geom_histogram(data = i_ye_2020, aes(.value/num_cells, fill = Area), alpha = 0.5) + 
