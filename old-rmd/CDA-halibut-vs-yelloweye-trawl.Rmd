...
d_hal <- readRDS("data-generated/halibut-hybrid-model-data.rds") %>%
  filter(latitude < 52.15507) %>%
  filter(year %in% years)
f <- paste0("models/halibut-hybrid-model-trawlinhbllyrs-400kn.rds")
if (!file.exists(f)) {
  m_halibut <- sdmTMB(
...
m_halibut <- readRDS(file = "models/halibut-hybrid-model-trawlinhbllyrs-400kn.rds")
# m_halibut <- readRDS(file = "models/halibut-hybrid-model-AR1-allyrs-400kn.rds")
...
f <- "models/yelloweye-hybrid-allyrs-400kn.rds"
if (!file.exists(f)) {
  m_ye <- sdmTMB(
    formula = density ~ 0 + as.factor(year) + as.factor(survey) +
      depth_scaled + I(depth_scaled^2),
...
m_ye <- readRDS(file = "models/yelloweye-hybrid-400kn-trawlinhbllyrs.rds")
...
```{r eval = TRUE}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-index-cda.rds"
if (!file.exists(f)) {
  p_hal_cda <- predict(m_halibut, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_cda, "data-generated/hybrid-halibut-trawlinhbllyrs-predictions-cda.rds")
  i_hal_cda <- get_index(p_hal_cda, bias_correct = F)
  saveRDS(i_hal_cda, f)
}

ss <- "data-generated/hybrid-halibut-trawlinhbllyrs-index-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_hal_noncda <- predict(m_halibut, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_noncda, "data-generated/hybrid-halibut-trawlinhbllyrs-predictions-3CD-outside-cda.rds")

  i_hal_noncda <- get_index(p_hal_noncda, bias_correct = F)
  saveRDS(i_hal_noncda, f)
}

ss <- "data-generated/hybrid-halibut-trawlinhbllyrs-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-index-5A.rds"
if (!file.exists(f)) {
  p_hal_5A <- predict(m_halibut, newdata = s_5A_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_noncda, "data-generated/hybrid-halibut-trawlinhbllyrs-predictions-5A.rds")

  i_hal_5A <- get_index(p_hal_5A, bias_correct = F)
  saveRDS(i_hal_5A, f)
}

ss <- "data-generated/hybrid-halibut-trawlinhbllyrs-index-5A-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-index-all-S.rds"
if (!file.exists(f)) {
  p_hal_S <- predict(m_halibut, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_S, "data-generated/hybrid-halibut-trawlinhbllyrs-predictions-all-S.rds")

  i_hal_S <- get_index(p_hal_S, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_hal_S, f)
}

ss <- "data-generated/hybrid-halibut-trawlinhbllyrs-index-all-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-index-hbll-S.rds"
if (!file.exists(f)) {
  
  hbll_s_grid <- filter(full_s_grid, survey == "HBLL")
  
  p_hal_Sb <- predict(m_halibut, newdata = hbll_s_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_Sb, "data-generated/hybrid-halibut-trawlinhbllyrs-predictions-hbll-S.rds")

  i_hal_Sb <- get_index(p_hal_Sb, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_hal_Sb, f)
}

ss <- "data-generated/hybrid-halibut-trawlinhbllyrs-index-hbll-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = TRUE}
f <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-index-cda.rds"
if (!file.exists(f)) {
  p_ye_cda <- predict(m_ye, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_cda, "data-generated/hybrid-yelloweye-trawlinhbllyrs-predictions-cda.rds")

  i_ye_cda <- get_index(p_ye_cda, bias_correct = F)
  saveRDS(i_ye_cda, f)
}

ss <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-index-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_ye_noncda <- predict(m_ye, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_noncda, "data-generated/hybrid-yelloweye-trawlinhbllyrs-predictions-3CD-outside-cda.rds")

  i_ye_noncda <- get_index(p_ye_noncda, bias_correct = F)
  saveRDS(i_ye_noncda, f)
}

ss <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-index-5A.rds"
if (!file.exists(f)) {
  p_ye_5A <- predict(m_ye, newdata = s_5A_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_5A, "data-generated/hybrid-yelloweye-trawlinhbllyrs-predictions-5A.rds")

  i_ye_5A <- get_index(p_ye_5A, bias_correct = F)
  saveRDS(i_ye_5A, f)
}

ss <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-index-5A-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-index-all-S.rds"
if (!file.exists(f)) {
  p_ye_S <- predict(m_ye, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_S, "data-generated/hybrid-yelloweye-trawlinhbllyrs-predictions-all-S.rds")

  i_ye_S <- get_index(p_ye_S, bias_correct = F)
  saveRDS(i_ye_S, f)
}

ss <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-index-all-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-index-hbll-S.rds"
if (!file.exists(f)) {
  
  hbll_s_grid <- filter(full_s_grid, survey == "HBLL")
  
  p_ye_Sb <- predict(m_ye, newdata = hbll_s_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_Sb, "data-generated/hybrid-yelloweye-trawlinhbllyrs-predictions-hbll-S.rds")

  i_ye_Sb <- get_index(p_ye_Sb, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_ye_Sb, f)
}

ss <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-index-hbll-S-sim-500.rds"
if (!file.exists(ss)) {
...
hybrid_pred <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-predictions-hbll-S.rds")
...
```{r echo=F, message=F, warning=F}
hybrid_pred <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-predictions-hbll-S.rds")
...
sim_hal_cda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-cda-sim-500.rds")[[2]]
sim_hal_noncda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-3CD-outside-cda-sim-500.rds")[[2]]
...
i_hal <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-hbll-S-sim-500.rds")[[1]]
i_ye <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-index-hbll-S-sim-500.rds")[[1]]
...
# i_hal_cda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-cda.rds")
# i_hal_noncda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-3CD-outside-cda.rds")
# i_hal_5A <- readRDS("data-generated/halibut-index-5A.rds")
i_hal <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-all-S-sim-500.rds")[[1]]
i_hal_cda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-cda-sim-500.rds")[[1]]
i_hal_noncda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-3CD-outside-cda-sim-500.rds")[[1]]
i_hal_5A <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-5A-sim-500.rds")[[1]]
i_hal_hbll <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-hbll-S-sim-500.rds")[[1]]
...
ggsave("figs/hybrid-halibut-trawlinhbllyrs-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-halibut-trawlinhbllyrs-average-index.png", width = 7, height = 4, dpi = 400)
```


```{r message=F, echo=F}
i_ye <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-index-all-S-sim-500.rds")[[1]]
i_ye_cda <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-index-cda-sim-500.rds")[[1]]
i_ye_noncda <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-index-3CD-outside-cda-sim-500.rds")[[1]]
i_ye_5A <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-index-5A-sim-500.rds")[[1]]

i_ye_hbll <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-index-hbll-S-sim-500.rds")[[1]]
...
ggplot(.dat, aes(year, est, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-yelloweye-trawlinhbllyrs-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-yelloweye-trawlinhbllyrs-average-index.png", width = 7, height = 4, dpi = 400)
```
...
```{r}
i_hal2 <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-all-S-sim-500.rds")[[2]]
i_hal_cda2 <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-cda-sim-500.rds")[[2]]
i_hal_noncda2 <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-3CD-outside-cda-sim-500.rds")[[2]]
i_hal_5A2 <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-index-5A-sim-500.rds")[[2]]
...
```{r}
i_ye2 <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-index-all-S-sim-500.rds")[[2]]
i_ye_cda2 <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-index-cda-sim-500.rds")[[2]]
i_ye_noncda2 <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-index-3CD-outside-cda-sim-500.rds")[[2]]
i_ye_5A2 <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-index-5A-sim-500.rds")[[2]]
...
ggsave("figs/hybrid-trawlinhbllyrs-estimated-biomass-densities.png", width = 5, height = 5, dpi = 400)
```
...
ggsave("figs/hybrid-halibut-trawlinhbllyrs-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
ggsave("figs/hybrid-yelloweye-trawlinhbllyrs-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
.dat <- .dat %>% filter(Area %in% c("non-CDA 3CD", "CDA", "HBLL South"))
...
ggplot(.dat, aes(year, ye_per_hal, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-ye-to-hal-index-trawlinhbllyrs.png", width = 7, height = 4, dpi = 400)
...
ggplot(.dat, aes(year, hal_per_ye, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-hal-to-ye-index-trawlinhbllyrs.png", width = 7, height = 4, dpi = 400)
...
```{r message=F, echo=F}
p_hal2020 <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-predictions-all-S.rds")[[1]] %>% filter(year == 2020)
d_hal_plots <- readRDS("data-generated/halibut-hybrid-model-data.rds") %>%
  ...
  filter(latitude < 52.15507) %>% filter(year %in% c(2018,2019,2020)) %>%  
  mutate(
...
ggsave("figs/hybrid-halibut-2020-predictions-trawlinhbllyrs.png", width = 5.5, height = 6, dpi = 400)
```

```{r map-predictions-all, message=F, echo=F, warning=F, cache=TRUE}
p_hal <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-predictions-all-S.rds")
...
d_hal_facet <- readRDS("data-generated/halibut-hybrid-model-data.rds") %>%
...
) + facet_wrap(~ as.factor(year)) + scale_size_area(min_size = 1, max_size = 4, n.breaks = 5)

# g <- g + theme(legend.position = c(0.35, 0), legend.justification = c(0,0))

ggsave("figs/hybrid-halibut-predictions-trawlinhbllyrs.png", width = 9, height = 10, dpi = 200)
```
...
```{r message=F, echo=F}
p_ye <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-predictions-all-S.rds")
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-yelloweye-2020-predictions-trawlinhbllyrs.png", width = 5.5, height = 6, dpi = 400)
```
...
d_ye_facet <- readRDS("data-generated/yelloweye-hybrid-model-data.rds") %>%
  filter(latitude < 52.15507) %>% filter(year %in% years) %>% 
  mutate(
    # back transform densities into catch per 100 hooks
    catch_equiv = round(density * (100 * 0.0024384 * 0.009144 * 10000) / yemeanweight), 
...
# g <- g + theme(legend.position = c(0.35, 0), legend.justification = c(0,0))
ggsave("figs/hybrid-ye-predictions-trawlinhbllyrs.png", width = 9, height = 10, dpi = 200)
```
...
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-ye-to-halibut-2020-w-hal-catch-trawlinhbllyrs.png", width = 5.5, height = 6, dpi = 400)
...
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-halibut-to-ye-2020-w-hal-catch-trawlinhbllyrs.png", width = 5.5, height = 6, dpi = 400)
...
```{r message=F, echo=F}
p_hal_cda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-predictions-cda.rds")
p_hal_noncda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-predictions-3CD-outside-cda.rds")
p_ye_cda <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-predictions-cda.rds")
p_ye_noncda <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-predictions-3CD-outside-cda.rds")
