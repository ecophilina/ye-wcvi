...
# saveRDS(sp_cda, "models/halibut-m5-spatial-predictions-cda.rds")
sp_cda <- readRDS("models/halibut-m5-spatial-predictions-cda.rds")

i_cda_sp <- get_index(sp_cda)
# saveRDS(i_cda_sp, "models/halibut-m5-cda-spatial-index.rds")

# sp_noncda <- predict(m5s, newdata = noncda_grid, se_fit = F, re_form = NULL, return_tmb_object = T)
# saveRDS(sp_noncda, "models/halibut-m5-spatial-predictions-noncda.rds")
sp_noncda <- readRDS("models/halibut-m5-spatial-predictions-noncda.rds")
...
gh3cd <- ggplot(data = focal_area) +
  ...
  ggtitle("HBLL observed and predicted Pacific Halibut catch per 100 hooks")
gh3cd
ggsave("halibut-m5-AR1-2020-predictions-3cd-outsideCDA.png", width = 6, height = 6)
```
