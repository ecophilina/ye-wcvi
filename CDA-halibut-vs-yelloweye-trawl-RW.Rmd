...
d_hal <- readRDS("data-generated/halibut-hybrid-model-data-paired.rds") %>%
  filter(latitude < 52.15507) %>%
  filter(year %in% years)
f <- paste0("models/halibut-hybrid-model-RW-400kn.rds")
if (!file.exists(f)) {
  m_halibut <- sdmTMB(
...
```{r echo = F}
m_halibut <- readRDS(file = "models/halibut-hybrid-model-RW-400kn.rds")
m_halibut
...
```{r eval = TRUE}
f <- paste0("models/halibut-hybrid-model-RW-wfixed-400kn.rds")
if (!file.exists(f)) {
  m_halibut2 <- sdmTMB(
    formula = density ~ 0 + as.factor(year) + as.factor(survey) +
      depth_scaled + I(depth_scaled^2),
...
```{r echo = F}
m_halibut2 <- readRDS(file = "models/halibut-hybrid-model-RW-wfixed-400kn.rds")
# m_halibut2
AIC(m_halibut2) 
```
...
f <- "models/yelloweye-hybrid-RW-400kn.rds"
if (!file.exists(f)) {
  m_ye <- sdmTMB(
    formula = density ~ 0 + as.factor(year) + as.factor(survey) +
      depth_scaled + I(depth_scaled^2),
...
```{r echo = F}
m_ye <- readRDS(file = "models/yelloweye-hybrid-RW-400kn.rds")
m_ye
...
```{r eval = TRUE, echo = F}
f <- "models/yelloweye-hybrid-RW-wfixedsp-400kn.rds"
if (!file.exists(f)) {
  m_ye2 <- sdmTMB(
    formula = density ~ 0 + as.factor(year) + as.factor(survey) +
      depth_scaled + I(depth_scaled^2),
...
```{r echo = F}
m_ye2 <- readRDS(file = "models/yelloweye-hybrid-RW-wfixedsp-400kn.rds")
```
...
```{r eval = TRUE, echo=F}
f <- "data-generated/hybrid-halibut-RW-index-cda.rds"
if (!file.exists(f)) {
  p_hal_cda <- predict(m_halibut, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_cda, "data-generated/hybrid-halibut-RW-predictions-cda.rds")
  i_hal_cda <- get_index(p_hal_cda, bias_correct = F)
  saveRDS(i_hal_cda, f)
}

ss <- "data-generated/hybrid-halibut-RW-index-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-RW-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_hal_noncda <- predict(m_halibut, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_noncda, "data-generated/hybrid-halibut-RW-predictions-3CD-outside-cda.rds")

  i_hal_noncda <- get_index(p_hal_noncda, bias_correct = F)
  saveRDS(i_hal_noncda, f)
}

ss <- "data-generated/hybrid-halibut-RW-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-RW-predictions-5A.rds"

if (!file.exists(f)) {
p_hal_5A <- predict(m_halibut, newdata = s_5A_grid, return_tmb_object = TRUE)
saveRDS(p_hal_5A, "data-generated/hybrid-halibut-RW-predictions-5A.rds")
}

f <- "data-generated/hybrid-halibut-RW-index-5A.rds"
if (!file.exists(f)) {
  i_hal_5A <- get_index(p_hal_5A, bias_correct = F)
  saveRDS(i_hal_5A, f)
}

ss <- "data-generated/hybrid-halibut-RW-index-5A-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-RW-index-all-S.rds"
# if (!file.exists(f)) {
  p_hal_S <- predict(m_halibut, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_S, "data-generated/hybrid-halibut-RW-predictions-all-S.rds")

  i_hal_S <- get_index(p_hal_S, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_hal_S, f)
# }

ss <- "data-generated/hybrid-halibut-RW-index-all-S-sim-500.rds"
# if (!file.exists(ss)) {
...
```{r eval = TRUE, echo=F}
f <- "data-generated/hybrid-yelloweye-RW-index-cda.rds"
# if (!file.exists(f)) {
  p_ye_cda <- predict(m_ye, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_cda, "data-generated/hybrid-yelloweye-RW-predictions-cda.rds")

  i_ye_cda <- get_index(p_ye_cda, bias_correct = F)
  saveRDS(i_ye_cda, f)
# }

ss <- "data-generated/hybrid-yelloweye-RW-index-cda-sim-500.rds"
# if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-RW-index-3CD-outside-cda.rds"
# if (!file.exists(f)) {
  p_ye_noncda <- predict(m_ye, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_noncda, "data-generated/hybrid-yelloweye-RW-predictions-3CD-outside-cda.rds")

  i_ye_noncda <- get_index(p_ye_noncda, bias_correct = F)
  saveRDS(i_ye_noncda, f)
# }

ss <- "data-generated/hybrid-yelloweye-RW-index-3CD-outside-cda-sim-500.rds"
# if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-RW-index-5A.rds"
# if (!file.exists(f)) {
  p_ye_5A <- predict(m_ye, newdata = s_5A_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_5A, "data-generated/hybrid-yelloweye-RW-predictions-5A.rds")

  i_ye_5A <- get_index(p_ye_5A, bias_correct = F)
  saveRDS(i_ye_5A, f)
# }

ss <- "data-generated/hybrid-yelloweye-RW-index-5A-sim-500.rds"
# if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-RW-index-all-S.rds"
# if (!file.exists(f)) {
  p_ye_S <- predict(m_ye, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_S, "data-generated/hybrid-yelloweye-RW-predictions-all-S.rds")

  i_ye_S <- get_index(p_ye_S, bias_correct = F)
  saveRDS(i_ye_S, f)
# }

ss <- "data-generated/hybrid-yelloweye-RW-index-all-S-sim-500.rds"
# if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-yelloweye-RW-index-hbll-S.rds"
# if (!file.exists(f)) {
  
  hbll_s_grid <- filter(full_s_grid, survey == "HBLL")
  
  p_ye_Sb <- predict(m_ye, newdata = hbll_s_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_Sb, "data-generated/hybrid-yelloweye-RW-predictions-hbll-S.rds")

  i_ye_Sb <- get_index(p_ye_Sb, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_ye_Sb, f)
# }

ss <- "data-generated/hybrid-yelloweye-RW-index-hbll-S-sim-500.rds"
# if (!file.exists(ss)) {
...
hybrid_pred <- readRDS("data-generated/hybrid-halibut-RW-predictions-hbll-S.rds")
...
```{r echo=F, message=F, warning=F}
hybrid_pred <- readRDS("data-generated/hybrid-yelloweye-RW-predictions-hbll-S.rds")
...
sim_hal_cda <- readRDS("data-generated/hybrid-halibut-RW-index-cda-sim-500.rds")[[2]]
sim_hal_noncda <- readRDS("data-generated/hybrid-halibut-RW-index-3CD-outside-cda-sim-500.rds")[[2]]
...
i_hal <- readRDS("data-generated/hybrid-halibut-RW-index-hbll-S-sim-500.rds")[[1]]
i_ye <- readRDS("data-generated/hybrid-yelloweye-RW-index-hbll-S-sim-500.rds")[[1]]
...
# i_hal_cda <- readRDS("data-generated/hybrid-halibut-RW-index-cda.rds")
# i_hal_noncda <- readRDS("data-generated/hybrid-halibut-RW-index-3CD-outside-cda.rds")
# i_hal_5A <- readRDS("data-generated/halibut-index-5A.rds")
i_hal <- readRDS("data-generated/hybrid-halibut-RW-index-all-S-sim-500.rds")[[1]]
i_hal_cda <- readRDS("data-generated/hybrid-halibut-RW-index-cda-sim-500.rds")[[1]]
i_hal_noncda <- readRDS("data-generated/hybrid-halibut-RW-index-3CD-outside-cda-sim-500.rds")[[1]]
i_hal_5A <- readRDS("data-generated/hybrid-halibut-RW-index-5A-sim-500.rds")[[1]]
i_hal_hbll <- readRDS("data-generated/hybrid-halibut-RW-index-hbll-S-sim-500.rds")[[1]]
...
ggsave("figs/hybrid-halibut-RW-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
```{r message=F, echo=F}
i_ye <- readRDS("data-generated/hybrid-yelloweye-RW-index-all-S-sim-500.rds")[[1]]
i_ye_cda <- readRDS("data-generated/hybrid-yelloweye-RW-index-cda-sim-500.rds")[[1]]
i_ye_noncda <- readRDS("data-generated/hybrid-yelloweye-RW-index-3CD-outside-cda-sim-500.rds")[[1]]
i_ye_5A <- readRDS("data-generated/hybrid-yelloweye-RW-index-5A-sim-500.rds")[[1]]

i_ye_hbll <- readRDS("data-generated/hybrid-yelloweye-RW-index-hbll-S-sim-500.rds")[[1]]
...
ggplot(.dat, aes(year, est, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-yelloweye-RW-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-halibut-RW-average-index.png", width = 7, height = 4, dpi = 400)
```
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-yelloweye-RW-average-index.png", width = 7, height = 4, dpi = 400)
```
...
```{r}
i_hal2 <- readRDS("data-generated/hybrid-halibut-RW-index-all-S-sim-500.rds")[[2]]
i_hal_cda2 <- readRDS("data-generated/hybrid-halibut-RW-index-cda-sim-500.rds")[[2]]
i_hal_noncda2 <- readRDS("data-generated/hybrid-halibut-RW-index-3CD-outside-cda-sim-500.rds")[[2]]
i_hal_5A2 <- readRDS("data-generated/hybrid-halibut-RW-index-5A-sim-500.rds")[[2]]
...
```{r}
i_ye2 <- readRDS("data-generated/hybrid-yelloweye-RW-index-all-S-sim-500.rds")[[2]]
i_ye_cda2 <- readRDS("data-generated/hybrid-yelloweye-RW-index-cda-sim-500.rds")[[2]]
i_ye_noncda2 <- readRDS("data-generated/hybrid-yelloweye-RW-index-3CD-outside-cda-sim-500.rds")[[2]]
i_ye_5A2 <- readRDS("data-generated/hybrid-yelloweye-RW-index-5A-sim-500.rds")[[2]]
...
ggsave("figs/hybrid-RW-estimated-biomass-densities.png", width = 5, height = 7, dpi = 400)
```
...
ggsave("figs/hybrid-halibut-RW-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
ggsave("figs/hybrid-yelloweye-RW-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
```{r message=F, echo=F}
p_hal2020 <- readRDS("data-generated/hybrid-halibut-RW-predictions-all-S.rds")[[1]] %>% 
  filter(year == 2020)
...
p_hal <- readRDS("data-generated/hybrid-halibut-RW-predictions-all-S.rds")
...
```{r message=F, echo=F}
p_ye <- readRDS("data-generated/hybrid-yelloweye-RW-predictions-all-S.rds")[[1]] %>% 
  filter(year == 2020)
...
p_ye <- readRDS("data-generated/hybrid-yelloweye-RW-predictions-all-S.rds")
...
```{r message=F, echo=F, warning=F}
p_hal_cda <- readRDS("data-generated/hybrid-halibut-RW-predictions-cda.rds")
p_ye_cda <- readRDS("data-generated/hybrid-yelloweye-RW-predictions-cda.rds")

p_hal_noncda <- readRDS("data-generated/hybrid-halibut-RW-predictions-3CD-outside-cda.rds")
p_ye_noncda <- readRDS("data-generated/hybrid-yelloweye-RW-predictions-3CD-outside-cda.rds")

p_hal_5A <- readRDS("data-generated/hybrid-halibut-RW-predictions-5A.rds")
p_ye_5A <- readRDS("data-generated/hybrid-yelloweye-RW-predictions-5A.rds")
