...
m_halibut
round(AIC(m_halibut))
# m_halibut500m <- readRDS(file = "models/halibut-hybrid-model-RW-w-mudd-rock-500m-400kn.rds")
...
f <- "models/yelloweye-hybrid-RW-w-mudd-rock-500m-400kn.rds"
if (!file.exists(f)) {
  m_ye <- sdmTMB(
...
```{r echo = F}
m_ye1km <- readRDS(file = "models/yelloweye-hybrid-RW-w-rocky-muddy-400kn.rds")
m_ye1km
round(AIC(m_ye1km))
# m_ye500m <- readRDS(file = "models/yelloweye-hybrid-RW-w-mudd-rock-500m-400kn.rds")
# m_ye500m
...
m_ye2
m_ye3 <- readRDS(file = "models/yelloweye-hybrid-RW-w-all-400kn.rds")
m_ye3
# round(AIC(m_ye1))
```
...
```{r eval = TRUE, echo=F}
f <- "data-generated/hybrid-halibut-RW-w-mudd-rock-index-cda.rds"
if (!file.exists(f)) {
  p_hal_cda <- predict(m_halibut, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_cda, "data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-cda.rds")
  i_hal_cda <- get_index(p_hal_cda, bias_correct = F)
  saveRDS(i_hal_cda, f)
}

ss <- "data-generated/hybrid-halibut-RW-w-mudd-rock-index-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-RW-w-mudd-rock-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_hal_noncda <- predict(m_halibut, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_noncda, "data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-3CD-outside-cda.rds")

  i_hal_noncda <- get_index(p_hal_noncda, bias_correct = F)
  saveRDS(i_hal_noncda, f)
}

ss <- "data-generated/hybrid-halibut-RW-w-mudd-rock-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-5A.rds"

if (!file.exists(f)) {
p_hal_5A <- predict(m_halibut, newdata = s_5A_grid, return_tmb_object = TRUE)
saveRDS(p_hal_5A, "data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-5A.rds")
}

f <- "data-generated/hybrid-halibut-RW-w-mudd-rock-index-5A.rds"
if (!file.exists(f)) {
  i_hal_5A <- get_index(p_hal_5A, bias_correct = F)
  saveRDS(i_hal_5A, f)
}

ss <- "data-generated/hybrid-halibut-RW-w-mudd-rock-index-5A-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-RW-w-mudd-rock-index-all-S.rds"
if (!file.exists(f)) {
  p_hal_S <- predict(m_halibut, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_S, "data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-all-S.rds")

  i_hal_S <- get_index(p_hal_S, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_hal_S, f)
}

ss <- "data-generated/hybrid-halibut-RW-w-mudd-rock-index-all-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-RW-w-mudd-rock-index-hbll-S.rds"
if (!file.exists(f)) {
  
  hbll_s_grid <- filter(full_s_grid, survey == "HBLL")
  
  p_hal_Sb <- predict(m_halibut, newdata = hbll_s_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_Sb, "data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-hbll-S.rds")

  i_hal_Sb <- get_index(p_hal_Sb, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_hal_Sb, f)
}

ss <- "data-generated/hybrid-halibut-RW-w-mudd-rock-index-hbll-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = TRUE, echo=F}
f <- "data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-cda.rds"
if (!file.exists(f)) {
  p_ye_cda <- predict(m_ye, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_cda, "data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-cda.rds")

  i_ye_cda <- get_index(p_ye_cda, bias_correct = F)
  saveRDS(i_ye_cda, f)
}

ss <- "data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_ye_noncda <- predict(m_ye, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_noncda, "data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-3CD-outside-cda.rds")

  i_ye_noncda <- get_index(p_ye_noncda, bias_correct = F)
  saveRDS(i_ye_noncda, f)
}

ss <- "data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-5A.rds"
if (!file.exists(f)) {
  p_ye_5A <- predict(m_ye, newdata = s_5A_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_5A, "data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-5A.rds")

  i_ye_5A <- get_index(p_ye_5A, bias_correct = F)
  saveRDS(i_ye_5A, f)
}

ss <- "data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-5A-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-all-S.rds"
if (!file.exists(f)) {
  p_ye_S <- predict(m_ye, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_S, "data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-all-S.rds")

  i_ye_S <- get_index(p_ye_S, bias_correct = F)
  saveRDS(i_ye_S, f)
}

ss <- "data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-all-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-hbll-S.rds"
if (!file.exists(f)) {
  
  hbll_s_grid <- filter(full_s_grid, survey == "HBLL")
  
  p_ye_Sb <- predict(m_ye, newdata = hbll_s_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_Sb, "data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-hbll-S.rds")

  i_ye_Sb <- get_index(p_ye_Sb, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_ye_Sb, f)
}

ss <- "data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-hbll-S-sim-500.rds"
if (!file.exists(ss)) {
...
hybrid_pred <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-hbll-S.rds")
...
```{r echo=F, message=F, warning=F}
hybrid_pred <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-hbll-S.rds")
...
sim_hal_cda <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-cda-sim-500.rds")[[2]]
sim_hal_noncda <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-3CD-outside-cda-sim-500.rds")[[2]]
...
i_hal <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-hbll-S-sim-500.rds")[[1]]
i_ye <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-hbll-S-sim-500.rds")[[1]]
...
# i_hal_cda <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-cda.rds")
# i_hal_noncda <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-3CD-outside-cda.rds")
# i_hal_5A <- readRDS("data-generated/halibut-index-5A.rds")
i_hal <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-all-S-sim-500.rds")[[1]]
i_hal_cda <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-cda-sim-500.rds")[[1]]
i_hal_noncda <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-3CD-outside-cda-sim-500.rds")[[1]]
i_hal_5A <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-5A-sim-500.rds")[[1]]
i_hal_hbll <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-hbll-S-sim-500.rds")[[1]]
...
ggsave("figs/hybrid-halibut-RW-w-mudd-rock-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
```{r message=F, echo=F}
i_ye <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-all-S-sim-500.rds")[[1]]
i_ye_cda <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-cda-sim-500.rds")[[1]]
i_ye_noncda <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-3CD-outside-cda-sim-500.rds")[[1]]
i_ye_5A <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-5A-sim-500.rds")[[1]]

i_ye_hbll <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-hbll-S-sim-500.rds")[[1]]
...
ggplot(.dat, aes(year, est, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-yelloweye-RW-w-mudd-rock-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-halibut-RW-w-mudd-rock-average-index.png", width = 7, height = 4, dpi = 400)
```
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-yelloweye-RW-w-mudd-rock-average-index.png", width = 7, height = 4, dpi = 400)
```
...
```{r}
i_hal2 <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-all-S-sim-500.rds")[[2]]
i_hal_cda2 <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-cda-sim-500.rds")[[2]]
i_hal_noncda2 <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-3CD-outside-cda-sim-500.rds")[[2]]
i_hal_5A2 <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-index-5A-sim-500.rds")[[2]]
...
```{r}
i_ye2 <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-all-S-sim-500.rds")[[2]]
i_ye_cda2 <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-cda-sim-500.rds")[[2]]
i_ye_noncda2 <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-3CD-outside-cda-sim-500.rds")[[2]]
i_ye_5A2 <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-index-5A-sim-500.rds")[[2]]
...
ggsave("figs/hybrid-RW-w-mudd-rock-estimated-biomass-densities.png", width = 5, height = 7, dpi = 400)
```
...
ggsave("figs/hybrid-halibut-RW-w-mudd-rock-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
ggsave("figs/hybrid-yelloweye-RW-w-mudd-rock-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
ggplot(.dat, aes(year, ye_per_hal, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-ye-to-hal-index-RW.png", width = 7, height = 4, dpi = 400)
...
ggplot(.dat, aes(year, hal_per_ye, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-hal-to-ye-index-RW.png", width = 7, height = 4, dpi = 400)
...
ggplot(.dat, aes(year, ye_per_hal, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-ye-to-halx-index-RW.png", width = 7, height = 4, dpi = 400)
...
ggplot(.dat, aes(year, hal_per_ye, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-halx-to-ye-index-RW.png", width = 7, height = 4, dpi = 400)
```
...
```{r message=F, echo=F}
p_hal2020 <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-all-S.rds")[[1]] %>% 
  filter(year == 2020)
...
ggsave("figs/hybrid-halibut-2020-predictions-RW.png", width = 5.5, height = 6, dpi = 400)
```

```{r map-predictions-all, message=F, echo=F, warning=F, cache=TRUE}
p_hal <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-all-S.rds")
...
f <- "figs/hybrid-halibut-predictions-RW.png"
if (!file.exists(f)) {
...
ggsave("figs/hybrid-halibut-predictions-RW.png", width = 9, height = 10, dpi = 200)
}
```
...
```{r message=F, echo=F}
p_ye <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-all-S.rds")[[1]] %>% 
  filter(year == 2020)
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-yelloweye-2020-predictions-RW.png", width = 5.5, height = 6, dpi = 400)
```

```{r ye-map-all, cache=TRUE, echo=F, message=F, warning=F}
p_ye <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-all-S.rds")
...
f <- "figs/hybrid-ye-predictions-RW.png"
if (!file.exists(f)) {
...
# g <- g + theme(legend.position = c(0.35, 0), legend.justification = c(0,0))
ggsave("figs/hybrid-ye-predictions-RW.png", width = 9, height = 10, dpi = 200)
}
```
...
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-ye-to-halibut-2020-w-hal-catch-RW.png", width = 5.5, height = 6, dpi = 400)
...
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-halibut-to-ye-2020-w-hal-catch-RW.png", width = 5.5, height = 6, dpi = 400)
...
```{r message=F, echo=F, warning=F}
p_hal_cda <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-cda.rds")
p_ye_cda <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-cda.rds")

p_hal_noncda <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-3CD-outside-cda.rds")
p_ye_noncda <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-3CD-outside-cda.rds")

p_hal_5A <- readRDS("data-generated/hybrid-halibut-RW-w-mudd-rock-predictions-5A.rds")
p_ye_5A <- readRDS("data-generated/hybrid-yelloweye-RW-w-mudd-rock-predictions-5A.rds")
