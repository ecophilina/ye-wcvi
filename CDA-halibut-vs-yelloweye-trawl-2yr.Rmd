...
substrate <- readRDS(file = "data-generated/events_w_substrate.rds") %>% select(X, Y, fishing_event_id, any_rock, rocky, mixed)
}
...
f <- paste0("models/halibut-hybrid-model-paired-400kn.rds")
if (!file.exists(f)) {
  m_halibut <- sdmTMB(
