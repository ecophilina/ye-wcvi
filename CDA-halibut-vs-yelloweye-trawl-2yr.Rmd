...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-5A.rds"
...
.pred <- readRDS(f)
 if(!nrow(.pred$data) == nrow(s_5A_grid)){
   p_hal_5A <- predict(m_halibut, newdata = s_5A_grid, return_tmb_object = TRUE)
   saveRDS(p_hal_5A, "data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-5A.rds")
 }
}
...
f <- "figs/hybrid-halibut-predictions-trawlinhbllyrs-paired.png"
if (!file.exists(f)) {
...
f <- "figs/hybrid-ye-predictions-trawlinhbllyrs-paired.png"
if (!file.exists(f)) {
