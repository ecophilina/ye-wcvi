...
cc %>% filter(year %in% c(2017, 2018, 2019, 2020, 2021)) %>%
ggplot(., 
    aes(
    ...
    geom_smooth(method = "lm") + 
    # geom_point(data=ccS_cda, colour= "red", alpha = 0.2) +
    #   geom_smooth(data=ccS_cda, method = "lm", colour= "red", fill= "red") + 
...
ggsave("figs/commercial-correlations-by-region-post2016.png", width = 3.5, height = 5.5, dpi = 400)
