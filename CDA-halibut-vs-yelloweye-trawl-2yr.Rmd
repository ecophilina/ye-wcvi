...
grid <- readRDS(file = f) %>% 
  filter(depth > 2 & depth < 650) # produces best match to combination of HBLL S and trawl grids 
}
...
full_s_grid_trim <- full_s_grid #%>% filter(depth <= 650)
...
# Map expected catch ratios (TODO: RERUN FROM HERE)
