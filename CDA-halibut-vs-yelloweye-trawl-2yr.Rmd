...
```{r eval = T, echo=F}
f <- "data-generated/filled-halibut-hbll-est-rock-mud-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_hal_noncda <- predict(m_halibut, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_noncda, "data-generated/filled-halibut-hbll-est-rock-mud-predictions-3CD-outside-cda.rds")

  i_hal_noncda <- get_index(p_hal_noncda, bias_correct = F)
  saveRDS(i_hal_noncda, f)
}

ss <- "data-generated/filled-halibut-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/filled-yelloweye-hbll-est-rock-mud-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_ye_noncda <- predict(m_ye, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_noncda, "data-generated/filled-yelloweye-hbll-est-rock-mud-predictions-3CD-outside-cda.rds")

  i_ye_noncda <- get_index(p_ye_noncda, bias_correct = F)
  saveRDS(i_ye_noncda, f)
}

ss <- "data-generated/filled-yelloweye-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
sim_hal_noncda <- readRDS("data-generated/filled-halibut-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds")[[2]]
...
# i_hal_noncda <- readRDS("data-generated/filled-halibut-hbll-est-rock-mud-index-3CD-outside-cda.rds")
...
i_hal_noncda <- readRDS("data-generated/filled-halibut-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds")[[1]]
...
i_ye_noncda <- readRDS("data-generated/filled-yelloweye-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds")[[1]]
...
i_hal_noncda2 <- readRDS("data-generated/filled-halibut-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds")[[2]]
...
i_ye_noncda2 <- readRDS("data-generated/filled-yelloweye-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds")[[2]]
...
```{r message=F, echo=F}
ggplot(i_hal_2020 %>% filter(Area %in% c("CDA", "non-CDA 3CD"))) + geom_histogram(aes(.value / num_cells, 
  fill = Area
  ), alpha = 0.5
  #, fill = "black"
  ) +
  geom_histogram(data = i_ye_2020 %>% filter(Area %in% c("CDA", "non-CDA 3CD")), aes(.value / num_cells, fill = Area), alpha = 0.75) +
  geom_vline(data = catch_per_cell%>% filter(Area %in% c("CDA", "non-CDA 3CD")), aes(xintercept = catch_med,
    colour = Area
    ), linetype = 2, alpha = 0.5
    #, colour = "black"
    ) +
  geom_vline(data = ye_catch_per_cell%>% filter(Area %in% c("CDA", "non-CDA 3CD")), aes(xintercept = catch_med, colour = Area), linetype = 2) +
...
ggplot(.dat, aes(year, ye_per_hal, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/filled-ye-to-halx-index-hbll-est-rock-mud.png", width = 7, height = 4, dpi = 400)
...
ggplot(catch_compN, aes(log(catch_count_hal+1), log(catch_count_ye+1))) + 
  geom_smooth(method = "lm", colour = "grey") +
  geom_jitter(aes(colour = survey), alpha=0.7) + 
  coord_cartesian()
...
p_hal_noncda <- readRDS("data-generated/filled-halibut-hbll-est-rock-mud-predictions-3CD-outside-cda.rds")
p_ye_noncda <- readRDS("data-generated/filled-yelloweye-hbll-est-rock-mud-predictions-3CD-outside-cda.rds")
