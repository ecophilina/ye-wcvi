...
```{r}
AIC(m_halibut_tweedie, m_halibut_delta, m_halibut_delta2, m_halibut_delta3)
```
...
```{r}
m_ye <- readRDS(file = "models/yelloweye-stitch-hbll-mw-rocky-muddy-400kn.rds")
m_ye0 <- readRDS(file = "models/yelloweye-stitch-hbll-mw-rocky-muddy-400kn-no-anisotropy-RW.rds")
m_ye1 <- readRDS(file = "models/yelloweye-stitch-hbll-mw-rocky-muddy-400kn-delta.rds")
```
...
AIC(m_ye, m_ye0, m_ye1) # worse by > 10 AIC
```
