...
f <- paste0("models/halibut-hybrid-keepable-model-rocky-muddy-400kn.rds")
if (!file.exists(f)) {
  m_halibut <- sdmTMB(
...
```{r echo = F}
m_halibut <- readRDS(file = "models/halibut-hybrid-keepable-model-rocky-muddy-400kn.rds")
m_halibut
round(AIC(m_halibut))
# m_halibut_tv <- readRDS(file = "models/halibut-hybrid-keepable-model-allsub-tv-depth-400kn.rds")
# m_halibut_tv
...
```{r eval = TRUE}
### Does an AR1 help?
# f <- paste0("models/halibut-hybrid-keepable-model-hbll-weights-AR1-400kn.rds")
# if (!file.exists(f)) {
#   m_halibut2 <- sdmTMB(
...
```{r echo = F}
# m_halibut2 <- readRDS(file = "models/halibut-hybrid-keepable-model-hbll-weights-AR1-400kn.rds")
# # m_halibut2
# Without it, AIC: 
...
# 
# round(AIC(m_halibut))
# m_halibut1 <- readRDS(file = "models/halibut-hybrid-keepable-model-rocky-400kn.rds")
# m_halibut1
# round(AIC(m_halibut1))
# m_halibut3 <- readRDS(file = "models/halibut-hybrid-keepable-model-allsub-400kn.rds")
# m_halibut3
...
```{r  echo=F}
f <- "data-generated/filled-keepable-halibut-est-rock-mud-index-cda.rds"
if (!file.exists(f)) {
  p_hal_cda <- predict(m_halibut, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_cda, "data-generated/filled-keepable-halibut-est-rock-mud-predictions-cda.rds")
  i_hal_cda <- get_index(p_hal_cda, bias_correct = F)
  saveRDS(i_hal_cda, f)
}

# ss <- "data-generated/filled-keepable-halibut-est-rock-mud-index-cda-sim-500.rds"
# if (!file.exists(ss)) {
...
```{r  echo=F}
f <- "data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_hal_noncda <- predict(m_halibut, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_noncda, "data-generated/filled-keepable-halibut-est-rock-mud-predictions-5A3CD-outside-cda.rds")

  i_hal_noncda <- get_index(p_hal_noncda, bias_correct = F)
  saveRDS(i_hal_noncda, f)
}

# ss <- "data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CD-outside-cda-sim-500.rds"
# if (!file.exists(ss)) {
#   i_hal_noncda2 <- get_all_sims(m_halibut, newdata = noncda_grid)
#   saveRDS(i_hal_noncda2, ss)
# }
# ss <- "data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CDN-outside-cda-sim-500.rds"
# if (!file.exists(ss)) {
#   i_hal_noncda2N <- get_all_sims(m_halibut, newdata = noncda_gridN)
#   saveRDS(i_hal_noncda2N, ss)
# }
# ss <- "data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CDS-outside-cda-sim-500.rds"
# if (!file.exists(ss)) {
...
```{r eval = F, echo=F}
f <- "data-generated/filled-keepable-halibut-est-rock-mud-predictions-5A.rds"

if (!file.exists(f)) {
p_hal_5A <- predict(m_halibut, newdata = s_5A_grid, return_tmb_object = TRUE)
saveRDS(p_hal_5A, "data-generated/filled-keepable-halibut-est-rock-mud-predictions-5A.rds")
}

f <- "data-generated/filled-keepable-halibut-est-rock-mud-index-5A.rds"
if (!file.exists(f)) {
  p_hal_5A <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-predictions-5A.rds")
  i_hal_5A <- get_index(p_hal_5A, bias_correct = F)
  saveRDS(i_hal_5A, f)
}

# ss <- "data-generated/filled-keepable-halibut-est-rock-mud-index-5A-sim-500.rds"
# if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/filled-keepable-halibut-est-rock-mud-index-all-S.rds"
if (!file.exists(f)) {
  p_hal_S <- predict(m_halibut, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_S, "data-generated/filled-keepable-halibut-est-rock-mud-predictions-all-S.rds")
...
# ss <- "data-generated/filled-keepable-halibut-est-rock-mud-index-list-sim-500.rds"
# if (!file.exists(ss)) {
#   i_hal_combined <- get_all_sims(m_halibut, newdata = full_s_grid)
#   saveRDS(i_hal_combined, ss)
# }

s1 <- "data-generated/filled-keepable-halibut-est-rock-mud-index-all-S-sim-500.rds"
if (!file.exists(s1)) {
  i_hal_combined <- get_all_sims(m_halibut, newdata = full_s_grid)
  saveRDS(i_hal_combined, ss)
...
s3 <- "data-generated/filled-keepable-halibut-est-rock-mud-index-cda-sim-500.rds"
if (!file.exists(s3)) {
  i_hal_cda2 <- i_hal_combined[[3]] 
  saveRDS(i_hal_cda2, s3)
}
s4 <- "data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CDN-outside-cda-sim-500.rds"
if (!file.exists(s4)) {
  i_hal_noncda2N <- i_hal_combined[[4]] 
  saveRDS(i_hal_noncda2N, s4)
}
s2 <- "data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CDS-outside-cda-sim-500.rds"
if (!file.exists(s2)) {
  i_hal_noncda2S <- i_hal_combined[[2]] 
  saveRDS(i_hal_noncda2S, s2)
}
s5 <- "data-generated/filled-keepable-halibut-est-rock-mud-index-other-sim-500.rds"
if (!file.exists(s5)) {
...
```{r eval = T, echo=F}
f <- "data-generated/filled-keepable-halibut-est-rock-mud-index-hbll-S.rds"
if (!file.exists(f)) {
  ...
  saveRDS(p_hal_Sb, "data-generated/filled-keepable-halibut-est-rock-mud-predictions-hbll-S.rds")

  i_hal_Sb <- get_index(p_hal_Sb, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_hal_Sb, f)
}

ss <- "data-generated/filled-keepable-halibut-est-rock-mud-index-hbll-S-sim-500.rds"
if (!file.exists(ss)) {
  i_hal_S2b <- get_all_sims(m_halibut, newdata = hbll_s_grid, split_by_region = F)
...
```{r eval = TRUE, echo=F}
f <- "data-generated/filled-keepable-yelloweye-est-rock-mud-index-cda.rds"
if (!file.exists(f)) {
  p_ye_cda <- predict(m_ye, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_cda, "data-generated/filled-keepable-yelloweye-est-rock-mud-predictions-cda.rds")

  i_ye_cda <- get_index(p_ye_cda, bias_correct = F)
  saveRDS(i_ye_cda, f)
}

# ss <- "data-generated/filled-keepable-yelloweye-est-rock-mud-index-cda-sim-500.rds"
# if (!file.exists(ss)) {
...
# }
# 
# ss <- "data-generated/filled-keepable-yelloweye-est-rock-mud-index-5A3CDN-outside-cda-sim-500.rds"
# if (!file.exists(ss)) {
#   i_ye_noncda2N <- get_all_sims(m_ye, newdata = noncda_gridN)
#   saveRDS(i_ye_noncda2N, ss)
# }
# 
# ss <- "data-generated/filled-keepable-yelloweye-est-rock-mud-index-5A3CDS-outside-cda-sim-500.rds"
# if (!file.exists(ss)) {
...
```{r eval = F, echo=F}
f <- "data-generated/filled-keepable-yelloweye-est-rock-mud-index-5A.rds"
if (!file.exists(f)) {
  p_ye_5A <- predict(m_ye, newdata = s_5A_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_5A, "data-generated/filled-keepable-yelloweye-est-rock-mud-predictions-5A.rds")

  i_ye_5A <- get_index(p_ye_5A, bias_correct = F)
  saveRDS(i_ye_5A, f)
}

# ss <- "data-generated/filled-keepable-yelloweye-est-rock-mud-index-5A-sim-500.rds"
# if (!file.exists(ss)) {
...
hybrid_pred <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-predictions-hbll-S.rds")
...
sim_hal_cda <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-cda-sim-500.rds")[[2]]
sim_hal_noncdaN <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CDN-outside-cda-sim-500.rds")[[2]]
sim_hal_noncdaS <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CDS-outside-cda-sim-500.rds")[[2]]
...
i_hal <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-hbll-S-sim-500.rds")[[1]]
...
# i_hal_cda <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-cda.rds")
# i_hal_noncda <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CD-outside-cda.rds")
# i_hal_5A <- readRDS("data-generated/halibut-index-5A.rds")
i_hal <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-all-S-sim-500.rds")[[1]]
i_hal_cda <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-cda-sim-500.rds")[[1]]
# i_hal_noncda <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CD-outside-cda-sim-500.rds")[[1]]
i_hal_noncdaN <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CDN-outside-cda-sim-500.rds")[[1]]
i_hal_noncdaS <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CDS-outside-cda-sim-500.rds")[[1]]
# i_hal_5A <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A-sim-500.rds")[[1]]
i_hal_hbll <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-hbll-S-sim-500.rds")[[1]]
...
ggsave("figs/filled-keepable-halibut-est-rock-mud-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
.dat$Area <- ordered(.dat$Area, levels = c("CDA", "non-CDA 3CD5A S of 50º", "3CD5A N of 50º", "5A", "Full combined", "HBLL grid only"))
ggplot(.dat, aes(year, est, fill = Area, colour = Area)) +
  geom_line(size = 1.25) +
  geom_ribbon(aes(ymin = lwr, ymax = upr), alpha = 0.2, colour = NA) +
  # geom_line(data = .dat1, linetype = 2) +
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/filled-keepable-halibut-est-rock-mud-average-index.png", width = 7, height = 4, dpi = 400)
```
...
```{r}
i_hal2 <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-all-S-sim-500.rds")[[2]]
i_hal_cda2 <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-cda-sim-500.rds")[[2]]
# i_hal_noncda2 <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CD-outside-cda-sim-500.rds")[[2]]
i_hal_noncda2N <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CDN-outside-cda-sim-500.rds")[[2]]
i_hal_noncda2S <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A3CDS-outside-cda-sim-500.rds")[[2]]
# i_hal_5A2 <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-index-5A-sim-500.rds")[[2]]
...
.dat2 <- bind_rows(
  ...
  mutate(i_hal_noncda2N, Area = "5A3CD N of 50º", area_size = (sum(noncda_gridN$area)/ 10000)),
...
.dat2$Area <- ordered(.dat2$Area, levels = c("CDA", "non-CDA 3CD5A", "5A3CD N of 50º", "non-CDA 3CD5A S of 50º", "5A", "Full combined"))
...
.dat2 <- bind_rows(
  ...
  mutate(i_ye_noncda2N, Area = "5A3CD N of 50º", area_size = (sum(noncda_gridN$area)/ 10000)),
...
```{r message=F, echo=F}
ggplot(i_hal_2020 %>% filter(Area %in% c("CDA","5A3CD N of 50º", "non-CDA 3CD5A S of 50º"))) + geom_histogram(aes(.value / area_size, 
  fill = Area
  ), alpha = 0.5
  #, fill = "black"
  ) +
  geom_histogram(data = i_ye_2020 %>% filter(Area %in% c("CDA", "5A3CD N of 50º", "non-CDA 3CD5A S of 50º")), 
    aes(.value / area_size, fill = Area), alpha = 0.75) +
  geom_vline(data = dens_per_hectare%>% filter(Area %in% c("CDA", "5A3CD N of 50º", "non-CDA 3CD5A S of 50º")),
  ...
  geom_vline(data = ye_dens_per_hectare %>% 
      filter(Area %in% c("CDA", "5A3CD N of 50º", "non-CDA 3CD5A S of 50º")), 
...
hal_ratios <- i_hal_2020 %>%
    select(-area_size, -region) %>%
  pivot_wider(names_from = Area, values_from = .value) %>%
  group_by(.iteration) %>%
  mutate(CDAto5A3CD = CDA / (CDA + `non-CDA 3CD5A S of 50º` + `5A3CD N of 50º`),
    CDAtoFull = CDA / (`Full combined`),
    prop5A3CDN = `5A3CD N of 50º`/(`non-CDA 3CD5A S of 50º` + `5A3CD N of 50º`),
    prop5A3CDS = `non-CDA 3CD5A S of 50º`/(`non-CDA 3CD5A S of 50º` + `5A3CD N of 50º`)
    )
...
ggsave("figs/filled-keepable-halibut-est-rock-mud-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
```{r message=F, echo=F, warning=F}
i_ye_noncda2Nb <- i_ye_noncda2N %>% rename(N = .value) %>% select(-region)
i_ye_noncda2Sb <- i_ye_noncda2S %>% rename(S = .value) %>% select(-region)
i_ye_noncda2 <- left_join(i_ye_noncda2Nb, i_ye_noncda2Sb) %>% mutate(.value = N + S) %>% select(-S,-N)
...
.i_ye <- bind_rows(
  ...
  mutate(i_ye_noncda2N, Area = "5A3CD N of 50º", num_cells = sum(noncda_gridN$area)/10000),
...
.i_ye$Area <- ordered(.i_ye$Area, 
  levels = c("CDA", "non-CDA 3CD5A", "non-CDA 3CD5A S of 50º", "5A3CD N of 50º", "5A", "Full combined"))


i_hal_noncda2Nb <- i_hal_noncda2N %>% rename(N = .value) %>% select(-region)
i_hal_noncda2Sb <- i_hal_noncda2S %>% rename(S = .value) %>% select(-region)
i_hal_noncda2 <- left_join(i_hal_noncda2Nb, i_hal_noncda2Sb) %>% mutate(.value = N + S) %>% select(-S,-N)
...
.i_hal <- bind_rows(
  ...
  mutate(i_hal_noncda2N, Area = "5A3CD N of 50º", num_cells = sum(noncda_gridN$area)/10000),
...
.dat3 <- .dat %>% filter(Area %in% c(
  "non-CDA 3CD5A S of 50º", "5A3CD N of 50º",
  # "non-CDA 3CD5A",
  "CDA"
  ))
...
.datx <- left_join(.i_ye, .i_hal) %>% mutate(
    ye_per_hal = (yelloweye) / (halibut*0.76), # convert to adam's estimates ye = 1.04
    hal_per_ye = (halibut*0.76) / (yelloweye)
  )  %>% 
  group_by(Area, year) %>%
  summarise(
    lwr = quantile(ye_per_hal, 0.025),
...
ggplot(.dat3, aes(year, ye_per_hal, fill = Area, colour = Area)) +
  ...
  # scale_x_continuous(breaks = seq(1950, 2050, 2)) +
  scale_linetype_manual(name = "Halibut size", values= c("dashed", "solid"),
    label = c("9.5 kg",  "12.45 kg")) +
  scale_x_continuous(
    labels=c("2007-2008", "2009-2010", "2011-2012", "2013-2014", "2015-2016","2017-2018","2019-2020"), 
    breaks = seq(2008, 2020, 2)) + 
  theme(plot.margin = margin(11 / 2, r = 11, 11 / 2, 11 / 2)) +
...
p_hal2020 <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-predictions-all-S.rds")[[1]] %>%
...
ggsave("figs/filled-keepable-halibut-2020-predictions-est-rock-mud.png", width = 5.5, height = 4.5, dpi = 400)
```
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/filled-keepable-halibut-2020-predictions-est-rock-mud-closeup.png", width = 6.75, height = 5.5, dpi = 400)
```

```{r map-predictions-all, message=F, echo=F, warning=F, cache=TRUE}
p_hal <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-predictions-all-S.rds")
...
f <- "figs/filled-keepable-halibut-predictions-est-rock-mud.png"
if (!file.exists(f)) {
...
ggsave("figs/filled-keepable-halibut-predictions-est-rock-mud.png", width = 10, height = 8, dpi = 200)
}
```
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/filled-keepable-yelloweye-2020-predictions-est-rock-mud.png", width = 5.5, height = 4.5, dpi = 400)
```
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/filled-keepable-yelloweye-2020-predictions-est-rock-mud-closeup.png", width = 6.75, height = 5.5, dpi = 400)
```
...
ggplot(catch_compN, aes(log(catch_equiv_hal+1), log(catch_equiv_ye+1))) + 
  ...
  coord_cartesian() + ggtitle("Trawl survey north of 50º latitude")

ggplot(catch_compN, aes(log(catch_count_hal+1), log(catch_count_ye+1))) + 
  geom_smooth(method = "lm", colour = "grey") +
  geom_jitter(alpha=0.5) + 
  coord_cartesian()+ ggtitle("HBLL survey north of 50º latitude")
...
ggplot(catch_compS, aes(log(catch_equiv_hal+1), log(catch_equiv_ye+1))) + 
  ...
  coord_cartesian() + ggtitle("Trawl survey south of 50º latitude")

ggplot(catch_compS, aes(log(catch_count_hal+1), log(catch_count_ye+1))) + 
  geom_smooth(method = "lm", colour = "grey") +
  geom_jitter(alpha=0.5) + 
  coord_cartesian()+ ggtitle("HBLL survey south of 50º latitude")
...
dir.create("figs", showWarnings = FALSE)
ggsave("figs/filled-keepable-halibut-to-ye-2020-w-hal-catch-est-rock-mud.png", width = 5.5, height = 6, dpi = 400)
# ggsave("figs/filled-keepable-halibut-to-ye-2020-w-hal-catch-S.pdf", width = 5.5, height = 6, dpi = 400)
```
...
```{r message=F, echo=F, warning=F}
p_hal_cda <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-predictions-cda.rds")
p_ye_cda <- readRDS("data-generated/filled-keepable-yelloweye-est-rock-mud-predictions-cda.rds")

p_hal_noncda <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-predictions-5A3CD-outside-cda.rds")
p_ye_noncda <- readRDS("data-generated/filled-keepable-yelloweye-est-rock-mud-predictions-5A3CD-outside-cda.rds")

p_hal_5A <- readRDS("data-generated/filled-keepable-halibut-est-rock-mud-predictions-5A.rds")
p_ye_5A <- readRDS("data-generated/filled-keepable-yelloweye-est-rock-mud-predictions-5A.rds")
