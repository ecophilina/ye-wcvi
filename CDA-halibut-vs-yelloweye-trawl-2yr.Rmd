...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/filled-keepable-halibut-2020-predictions-est-rock-mud-closeup.png", width = 5.5, height = 5, dpi = 400)
```
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/filled-keepable-yelloweye-2020-predictions-est-rock-mud-closeup.png", width = 5.5, height = 5, dpi = 400)
```
