...
# ## code to modify to fill in gaps by intersecting with 5A3CD shape file?
# hbll_s_grid <- readRDS(here::here("grids/hbll_s_grid.rds"))
# 
# hbll_sf <- st_as_sf(hbll_s_grid$grid, coords = c("longitude", "latitude"), crs = 4326)
...
grid <- readRDS(here::here("grids/nd_all_synoptic_new.rds")) %>% 
  mutate(#X = round(X), Y = round(Y),
    X = X / 100, Y = Y / 100,
    depth_m = depth
  ) %>% select(X, Y, depth_m) %>%
...
if(sum(is.na(grid$muddy))) { stop("Check for missing substrate data before running models.")}
...
```{r eval = TRUE, echo=F}
f <- "data-generated/hybrid-halibut-hbll-est-rock-mud-index-cda.rds"
if (!file.exists(f)) {
  p_hal_cda <- predict(m_halibut, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_cda, "data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-cda.rds")
  i_hal_cda <- get_index(p_hal_cda, bias_correct = F)
  saveRDS(i_hal_cda, f)
}

ss <- "data-generated/hybrid-halibut-hbll-est-rock-mud-index-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-hbll-est-rock-mud-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_hal_noncda <- predict(m_halibut, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_noncda, "data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-3CD-outside-cda.rds")

  i_hal_noncda <- get_index(p_hal_noncda, bias_correct = F)
  saveRDS(i_hal_noncda, f)
}

ss <- "data-generated/hybrid-halibut-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-5A.rds"

if (!file.exists(f)) {
p_hal_5A <- predict(m_halibut, newdata = s_5A_grid, return_tmb_object = TRUE)
saveRDS(p_hal_5A, "data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-5A.rds")
}

f <- "data-generated/hybrid-halibut-hbll-est-rock-mud-index-5A.rds"
if (!file.exists(f)) {
  p_hal_5A <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-5A.rds")
  i_hal_5A <- get_index(p_hal_5A, bias_correct = F)
  saveRDS(i_hal_5A, f)
}

ss <- "data-generated/hybrid-halibut-hbll-est-rock-mud-index-5A-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-hbll-est-rock-mud-index-all-S.rds"
if (!file.exists(f)) {
  p_hal_S <- predict(m_halibut, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_S, "data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-all-S.rds")

  i_hal_S <- get_index(p_hal_S, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_hal_S, f)
}

ss <- "data-generated/hybrid-halibut-hbll-est-rock-mud-index-all-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-hbll-est-rock-mud-index-hbll-S.rds"
if (!file.exists(f)) {
  
  hbll_s_grid <- filter(full_s_grid, source_data == "HBLL")
  
  p_hal_Sb <- predict(m_halibut, newdata = hbll_s_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_Sb, "data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-hbll-S.rds")

  i_hal_Sb <- get_index(p_hal_Sb, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_hal_Sb, f)
}

ss <- "data-generated/hybrid-halibut-hbll-est-rock-mud-index-hbll-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = TRUE, echo=F}
f <- "data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-cda.rds"
if (!file.exists(f)) {
  p_ye_cda <- predict(m_ye, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_cda, "data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-cda.rds")

  i_ye_cda <- get_index(p_ye_cda, bias_correct = F)
  saveRDS(i_ye_cda, f)
}

ss <- "data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_ye_noncda <- predict(m_ye, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_noncda, "data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-3CD-outside-cda.rds")

  i_ye_noncda <- get_index(p_ye_noncda, bias_correct = F)
  saveRDS(i_ye_noncda, f)
}

ss <- "data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-5A.rds"
if (!file.exists(f)) {
  p_ye_5A <- predict(m_ye, newdata = s_5A_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_5A, "data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-5A.rds")

  i_ye_5A <- get_index(p_ye_5A, bias_correct = F)
  saveRDS(i_ye_5A, f)
}

ss <- "data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-5A-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-all-S.rds"
if (!file.exists(f)) {
  p_ye_S <- predict(m_ye, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_S, "data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-all-S.rds")

  i_ye_S <- get_index(p_ye_S, bias_correct = F)
  saveRDS(i_ye_S, f)
}

ss <- "data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-all-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-hbll-S.rds"
if (!file.exists(f)) {
  
  hbll_s_grid <- filter(full_s_grid, source_data == "HBLL")
  
  p_ye_Sb <- predict(m_ye, newdata = hbll_s_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_Sb, "data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-hbll-S.rds")

  i_ye_Sb <- get_index(p_ye_Sb, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_ye_Sb, f)
}

ss <- "data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-hbll-S-sim-500.rds"
if (!file.exists(ss)) {
...
hybrid_pred <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-hbll-S.rds")
...
```{r echo=F, message=F, warning=F}
hybrid_pred <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-hbll-S.rds")
...
sim_hal_cda <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-cda-sim-500.rds")[[2]]
sim_hal_noncda <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds")[[2]]
...
i_hal <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-hbll-S-sim-500.rds")[[1]]
i_ye <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-hbll-S-sim-500.rds")[[1]]
...
# i_hal_cda <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-cda.rds")
# i_hal_noncda <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-3CD-outside-cda.rds")
# i_hal_5A <- readRDS("data-generated/halibut-index-5A.rds")
i_hal <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-all-S-sim-500.rds")[[1]]
i_hal_cda <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-cda-sim-500.rds")[[1]]
i_hal_noncda <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds")[[1]]
i_hal_5A <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-5A-sim-500.rds")[[1]]
i_hal_hbll <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-hbll-S-sim-500.rds")[[1]]
...
ggsave("figs/hybrid-halibut-hbll-est-rock-mud-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
```{r message=F, echo=F}
i_ye <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-all-S-sim-500.rds")[[1]]
i_ye_cda <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-cda-sim-500.rds")[[1]]
i_ye_noncda <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds")[[1]]
i_ye_5A <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-5A-sim-500.rds")[[1]]

i_ye_hbll <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-hbll-S-sim-500.rds")[[1]]
...
ggplot(.dat, aes(year, est, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-yelloweye-hbll-est-rock-mud-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-halibut-hbll-est-rock-mud-average-index.png", width = 7, height = 4, dpi = 400)
```
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-yelloweye-hbll-est-rock-mud-average-index.png", width = 7, height = 4, dpi = 400)
```
...
```{r}
i_hal2 <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-all-S-sim-500.rds")[[2]]
i_hal_cda2 <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-cda-sim-500.rds")[[2]]
i_hal_noncda2 <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds")[[2]]
i_hal_5A2 <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-index-5A-sim-500.rds")[[2]]
...
```{r}
i_ye2 <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-all-S-sim-500.rds")[[2]]
i_ye_cda2 <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-cda-sim-500.rds")[[2]]
i_ye_noncda2 <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-3CD-outside-cda-sim-500.rds")[[2]]
i_ye_5A2 <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-index-5A-sim-500.rds")[[2]]
...
ggsave("figs/hybrid-hbll-est-rock-mud-estimated-biomass-densities.png", width = 6, height = 4, dpi = 400)
```
...
ggsave("figs/hybrid-halibut-hbll-est-rock-mud-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
ggsave("figs/hybrid-yelloweye-hbll-est-rock-mud-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
ggplot(.dat, aes(year, ye_per_hal, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-ye-to-hal-index-hbll-est-rock-mud.png", width = 7, height = 4, dpi = 400)
...
ggplot(.dat, aes(year, hal_per_ye, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-hal-to-ye-index-hbll-est-rock-mud.png", width = 7, height = 4, dpi = 400)
...
ggplot(.dat, aes(year, ye_per_hal, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-ye-to-halx-index-hbll-est-rock-mud.png", width = 7, height = 4, dpi = 400)
...
ggplot(.dat, aes(year, hal_per_ye, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-halx-to-ye-index-hbll-est-rock-mud.png", width = 7, height = 4, dpi = 400)
```
...
p_hal2020 <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-all-S.rds")[[1]] %>%
...
ggsave("figs/hybrid-halibut-2020-predictions-hbll-est-rock-mud.png", width = 5.5, height = 4.5, dpi = 400)
```
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-halibut-2020-predictions-hbll-est-rock-mud-closeup.png", width = 6.75, height = 5.5, dpi = 400)
```

```{r map-predictions-all, message=F, echo=F, warning=F, cache=TRUE}
p_hal <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-all-S.rds")
...
f <- "figs/hybrid-halibut-predictions-hbll-est-rock-mud.png"
if (!file.exists(f)) {
...
ggsave("figs/hybrid-halibut-predictions-hbll-est-rock-mud.png", width = 10, height = 8, dpi = 200)
}
```
...
```{r message=F, echo=F}
p_ye <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-all-S.rds")[[1]] %>% 
  filter(year == 2020)
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-yelloweye-2020-predictions-hbll-est-rock-mud.png", width = 5.5, height = 4.5, dpi = 400)
```
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-yelloweye-2020-predictions-hbll-est-rock-mud-closeup.png", width = 6.75, height = 5.5, dpi = 400)
```
...
ggplot(catch_compN, aes(catch_equiv_hal, catch_equiv_ye)) + 
...
ggplot(catch_compS, aes(catch_equiv_hal, catch_equiv_ye)) + 
  geom_smooth(method = "lm", colour = "grey") +
  geom_jitter(aes(colour = survey)) + 
  coord_cartesian(xlim=c(0, 12))
...
p_ye <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-all-S.rds")
...
f <- "figs/hybrid-ye-predictions-hbll-est-rock-mud.png"
if (!file.exists(f)) {
...
# g <- g + theme(legend.position = c(0.35, 0), legend.justification = c(0,0))
ggsave("figs/hybrid-ye-predictions-hbll-est-rock-mud.png", width = 10, height = 8, dpi = 200)
}
```
...
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-ye-to-halibut-2020-w-hal-catch-hbll-est-rock-mud.png", width = 5.5, height = 6, dpi = 400)
...
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-halibut-to-ye-2020-w-hal-catch-hbll-est-rock-mud.png", width = 5.5, height = 6, dpi = 400)
...
```{r message=F, echo=F, warning=F}
p_hal_cda <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-cda.rds")
p_ye_cda <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-cda.rds")

p_hal_noncda <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-3CD-outside-cda.rds")
p_ye_noncda <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-3CD-outside-cda.rds")

p_hal_5A <- readRDS("data-generated/hybrid-halibut-hbll-est-rock-mud-predictions-5A.rds")
p_ye_5A <- readRDS("data-generated/hybrid-yelloweye-hbll-est-rock-mud-predictions-5A.rds")
