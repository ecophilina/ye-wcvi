...
ggsave("figs/hybrid-hbll-est-rock-mud-estimated-biomass-densities.png", width = 5, height = 7, dpi = 400)
```
...
ggsave("figs/hybrid-halibut-2020-predictions-hbll-est-rock-mud.png", width = 5.5, height = 6, dpi = 400)
```
...
ggsave("figs/hybrid-halibut-predictions-hbll-est-rock-mud.png", width = 9, height = 10, dpi = 200)
}
```
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-yelloweye-2020-predictions-hbll-est-rock-mud.png", width = 5.5, height = 6, dpi = 400)
```
...
# g <- g + theme(legend.position = c(0.35, 0), legend.justification = c(0,0))
ggsave("figs/hybrid-ye-predictions-hbll-est-rock-mud.png", width = 9, height = 10, dpi = 200)
}
```
