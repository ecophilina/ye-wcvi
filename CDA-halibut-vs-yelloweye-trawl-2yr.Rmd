...
cc <- readRDS("data/hal-ye-ll-cpue-anon.rds") %>% 
  ...
  mutate(month = month(best_date), season = ifelse(month>3 & month<10, "Summer", "Winter"))
...
# ggsave("figs/commercial-correlations-by-year-all-sectors.png", width = 5.5, height = 3.5, dpi = 400)
ggsave("figs/commercial-correlations-by-year-by-season.png", width = 5.5, height = 5.5, dpi = 400)
