...
d_hal <- readRDS("data-generated/halibut-hybrid-model-data-paired.rds") %>%
  filter(latitude < 52.15507) %>%
  filter(year %in% years)
f <- paste0("models/halibut-hybrid-model-trawlinhbllyrs-paired-400kn.rds")
if (!file.exists(f)) {
  m_halibut <- sdmTMB(
...
```{r echo = F}
m_halibut <- readRDS(file = "models/halibut-hybrid-model-trawlinhbllyrs-paired-400kn.rds")
m_halibut
...
```{r eval = TRUE}
f <- paste0("models/halibut-hybrid-model-trawlinhbllyrs-paired-AR1-400kn.rds")
if (!file.exists(f)) {
  m_halibut <- sdmTMB(
    formula = density ~ 0 + as.factor(year) + as.factor(survey) +
      depth_scaled + I(depth_scaled^2),
...
```{r echo = F}
m_halibut2 <- readRDS(file = "models/halibut-hybrid-model-trawlinhbllyrs-paired-AR1-400kn.rds")
# m_halibut2
AIC(m_halibut2) 
```
...
f <- "models/yelloweye-hybrid-trawlinhbllyrs-paired-400kn.rds"
if (!file.exists(f)) {
  m_ye <- sdmTMB(
    formula = density ~ 0 + as.factor(year) + as.factor(survey) +
      depth_scaled + I(depth_scaled^2),
...
```{r echo = F}
m_ye <- readRDS(file = "models/yelloweye-hybrid-trawlinhbllyrs-paired-400kn.rds")
m_ye
...
```{r eval = TRUE, echo = F}
f <- "models/yelloweye-hybrid-trawlinhbllyrs-paired-sp-only-400kn.rds"
if (!file.exists(f)) {
  m_ye <- sdmTMB(
    formula = density ~ 0 + as.factor(year) + as.factor(survey) +
      depth_scaled + I(depth_scaled^2),
...
```{r echo = F}
m_ye2 <- readRDS(file = "models/yelloweye-hybrid-trawlinhbllyrs-paired-sp-only-400kn.rds")
```
...
```{r eval = TRUE, echo=F}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-cda.rds"
if (!file.exists(f)) {
  p_hal_cda <- predict(m_halibut, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_cda, "data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-cda.rds")
  i_hal_cda <- get_index(p_hal_cda, bias_correct = F)
  saveRDS(i_hal_cda, f)
}

ss <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_hal_noncda <- predict(m_halibut, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_noncda, "data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-3CD-outside-cda.rds")

  i_hal_noncda <- get_index(p_hal_noncda, bias_correct = F)
  saveRDS(i_hal_noncda, f)
}

ss <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-5A.rds"
if (!file.exists(f)) {
  p_hal_5A <- predict(m_halibut, newdata = s_5A_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_noncda, "data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-5A.rds")

  i_hal_5A <- get_index(p_hal_5A, bias_correct = F)
  saveRDS(i_hal_5A, f)
}

ss <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-5A-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-all-S.rds"
if (!file.exists(f)) {
  p_hal_S <- predict(m_halibut, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_S, "data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-all-S.rds")

  i_hal_S <- get_index(p_hal_S, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_hal_S, f)
}

ss <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-all-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-hbll-S.rds"
if (!file.exists(f)) {
  
  hbll_s_grid <- filter(full_s_grid, survey == "HBLL")
  
  p_hal_Sb <- predict(m_halibut, newdata = hbll_s_grid, return_tmb_object = TRUE)
  saveRDS(p_hal_Sb, "data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-hbll-S.rds")

  i_hal_Sb <- get_index(p_hal_Sb, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_hal_Sb, f)
}

ss <- "data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-hbll-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = TRUE, echo=F}
f <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-cda.rds"
if (!file.exists(f)) {
  p_ye_cda <- predict(m_ye, newdata = cda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_cda, "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-cda.rds")

  i_ye_cda <- get_index(p_ye_cda, bias_correct = F)
  saveRDS(i_ye_cda, f)
}

ss <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-3CD-outside-cda.rds"
if (!file.exists(f)) {
  p_ye_noncda <- predict(m_ye, newdata = noncda_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_noncda, "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-3CD-outside-cda.rds")

  i_ye_noncda <- get_index(p_ye_noncda, bias_correct = F)
  saveRDS(i_ye_noncda, f)
}

ss <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-3CD-outside-cda-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-5A.rds"
if (!file.exists(f)) {
  p_ye_5A <- predict(m_ye, newdata = s_5A_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_5A, "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-5A.rds")

  i_ye_5A <- get_index(p_ye_5A, bias_correct = F)
  saveRDS(i_ye_5A, f)
}

ss <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-5A-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T, echo=F}
f <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-all-S.rds"
if (!file.exists(f)) {
  p_ye_S <- predict(m_ye, newdata = full_s_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_S, "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-all-S.rds")

  i_ye_S <- get_index(p_ye_S, bias_correct = F)
  saveRDS(i_ye_S, f)
}

ss <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-all-S-sim-500.rds"
if (!file.exists(ss)) {
...
```{r eval = T}
f <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-hbll-S.rds"
if (!file.exists(f)) {
  
  hbll_s_grid <- filter(full_s_grid, survey == "HBLL")
  
  p_ye_Sb <- predict(m_ye, newdata = hbll_s_grid, return_tmb_object = TRUE)
  saveRDS(p_ye_Sb, "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-hbll-S.rds")

  i_ye_Sb <- get_index(p_ye_Sb, bias_correct = F) # bias_correction not working only for full grid
  saveRDS(i_ye_Sb, f)
}

ss <- "data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-hbll-S-sim-500.rds"
if (!file.exists(ss)) {
...
hybrid_pred <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-hbll-S.rds")
...
ggplot(d_test, aes(log_count, log_biomass)) + geom_point(alpha = 0.1) + facet_wrap(~year_true)
```

```{r echo=F, message=F, warning=F}
hybrid_pred <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-hbll-S.rds")
...
sim_hal_cda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-cda-sim-500.rds")[[2]]
sim_hal_noncda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-3CD-outside-cda-sim-500.rds")[[2]]
...
i_hal <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-hbll-S-sim-500.rds")[[1]]
i_ye <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-hbll-S-sim-500.rds")[[1]]
...
# i_hal_cda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-cda.rds")
# i_hal_noncda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-3CD-outside-cda.rds")
...
i_hal_hbll <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-hbll-S-sim-500.rds")[[1]]
...
ggsave("figs/hybrid-halibut-trawlinhbllyrs-paired-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
i_ye_hbll <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-hbll-S-sim-500.rds")[[1]]
...
ggplot(.dat, aes(year, est, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-yelloweye-trawlinhbllyrs-paired-index-by-area.png", width = 7, height = 4, dpi = 400)
```
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-halibut-trawlinhbllyrs-paired-average-index.png", width = 7, height = 4, dpi = 400)
```
...
ggplot(.dat, aes(year, est)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-yelloweye-trawlinhbllyrs-paired-average-index.png", width = 7, height = 4, dpi = 400)
```
...
```{r}
i_hal2 <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-all-S-sim-500.rds")[[2]]
i_hal_cda2 <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-cda-sim-500.rds")[[2]]
i_hal_noncda2 <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-3CD-outside-cda-sim-500.rds")[[2]]
i_hal_5A2 <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-index-5A-sim-500.rds")[[2]]
...
```{r}
i_ye2 <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-all-S-sim-500.rds")[[2]]
i_ye_cda2 <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-cda-sim-500.rds")[[2]]
i_ye_noncda2 <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-3CD-outside-cda-sim-500.rds")[[2]]
i_ye_5A2 <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-index-5A-sim-500.rds")[[2]]
...
ggsave("figs/hybrid-trawlinhbllyrs-paired-estimated-biomass-densities.png", width = 5, height = 7, dpi = 400)
```
...
ggsave("figs/hybrid-halibut-trawlinhbllyrs-paired-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
ggsave("figs/hybrid-yelloweye-trawlinhbllyrs-paired-relative-biomass.png", width = 7, height = 3, dpi = 400)
```
...
ggplot(.dat, aes(year, ye_per_hal, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-ye-to-hal-index-trawlinhbllyrs-paired.png", width = 7, height = 4, dpi = 400)
...
ggplot(.dat, aes(year, hal_per_ye, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-hal-to-ye-index-trawlinhbllyrs-paired.png", width = 7, height = 4, dpi = 400)
...
ggplot(.dat, aes(year, ye_per_hal, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-ye-to-halx-index-trawlinhbllyrs-paired.png", width = 7, height = 4, dpi = 400)
...
ggplot(.dat, aes(year, hal_per_ye, fill = Area, colour = Area)) +
  ...
  scale_fill_brewer(palette = "Set1") +
  scale_colour_brewer(palette = "Set1")
ggsave("figs/hybrid-halx-to-ye-index-trawlinhbllyrs-paired.png", width = 7, height = 4, dpi = 400)
```
...
2020 predictions with all survey catches post-2016

```{r message=F, echo=F}
p_hal2020 <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-all-S.rds")[[1]] %>% 
  filter(year == 2020)
...
ggsave("figs/hybrid-halibut-2020-predictions-trawlinhbllyrs-paired.png", width = 5.5, height = 6, dpi = 400)
```

```{r map-predictions-all, message=F, echo=F, warning=F, cache=TRUE}
p_hal <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-all-S.rds")
...
ggsave("figs/hybrid-halibut-predictions-trawlinhbllyrs-paired.png", width = 9, height = 10, dpi = 200)
```
...
```{r message=F, echo=F}
p_ye <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-all-S.rds")[[1]] %>% 
  filter(year == 2020)
...
g
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-yelloweye-2020-predictions-trawlinhbllyrs-paired.png", width = 5.5, height = 6, dpi = 400)
```

```{r ye-map-all, cache=TRUE, echo=F, message=F, warning=F}
p_ye <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-all-S.rds")
...
# g <- g + theme(legend.position = c(0.35, 0), legend.justification = c(0,0))
ggsave("figs/hybrid-ye-predictions-trawlinhbllyrs-paired.png", width = 9, height = 10, dpi = 200)
```
...
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-ye-to-halibut-2020-w-hal-catch-trawlinhbllyrs-paired.png", width = 5.5, height = 6, dpi = 400)
...
dir.create("figs", showWarnings = FALSE)
ggsave("figs/hybrid-halibut-to-ye-2020-w-hal-catch-trawlinhbllyrs-paired.png", width = 5.5, height = 6, dpi = 400)
...
red = CDA
black = 3CD outside CDA

```{r message=F, echo=F}
p_hal_cda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-cda.rds")
p_hal_noncda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-3CD-outside-cda.rds")
p_ye_cda <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-cda.rds")
p_ye_noncda <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-3CD-outside-cda.rds")
...
ggplot(ratio_noncda) +
  geom_point(aes(halibut, yelloweye), alpha = 0.25) +
  geom_point(
    data = ratio_cda, aes(halibut, yelloweye),
    inherit.aes = F, colour = "red", alpha = 0.25
  ) +
...
# 
ggplot(filter(
  ratio_noncda, halibut > 0.1 * 22 # & yelloweye > 0.1
)) +
  geom_histogram(aes(hal_per_ye), fill = "black") +
  geom_histogram(data = filter(
    ratio_cda, halibut >  0.1 * 22# & yelloweye > 0.1
...
ggplot() + 
  geom_line(data = ratio_noncda, 
    aes(x = ordered, y = cumsum_ye_hal, lty = "solid", colour = "darkblue"), size = 1) +
  
  geom_line(data = ratio_cda, 
    aes(x = ordered, y = cumsum_ye_hal, lty = "solid", colour = "red"), size = 1,
    inherit.aes = FALSE) +
   coord_cartesian(expand = F, xlim = c(0, 200), ylim = c(0, 0.25)) +
...
cda_2020 <- filter(cda_grid, year == 2020)
...
top_cell_increments <- ratio_cda  %>% group_by(year) %>% 
  filter(ordered %in% c( 
    round((nrow(cda_2020))*.01), 
    round((nrow(cda_2020))*.02),
    round((nrow(cda_2020))*.03), round((nrow(cda_2020))*.04),
    round((nrow(cda_2020))*.05), round((nrow(cda_2020))*.1), round((nrow(cda_2020))*.2)
    # , round((nrow(cda_2020))*.3), round((nrow(cda_2020))*.4), round((nrow(cda_2020))*.5), round((nrow(cda_2020))*.75), round((nrow(cda_2020))*1)
    )) %>% 
  mutate(
    mean_ratio = (ye_cumsum/ordered)/(hal_cumsum/ordered),
    mean_hal_ratio = (hal_cumsum/ordered)/(ye_cumsum/ordered),
    proportion = ordered/nrow(cda_2020))

noncda_cell_increments <- ratio_noncda  %>% group_by(year) %>% 
  filter(ordered %in% c( 
    round((nrow(cda_2020))*.01), 
    round((nrow(cda_2020))*.02),
    round((nrow(cda_2020))*.03), round((nrow(cda_2020))*.04),
...
ggplot() + 
  geom_line(data = noncda_cell_increments,
    aes(x = ordered, y = mean_ratio, #lty = "solid", 
      colour = "darkblue"), size = 1) +
  geom_line(data = top_cell_increments, 
    aes(x = ordered, y = mean_ratio, #lty = "solid", 
      colour = "red"), size = 1,
    inherit.aes = FALSE) +
   # coord_cartesian(expand = F, xlim = c(0, 0.2),# ylim = c(0, 0.25)) +
  scale_color_identity(name = "Area",
                          breaks = c("darkblue", "red"),
                          labels = c("3CD (non-CDA)", "CDA"),
                          guide = "legend") +
  facet_wrap(~year, ncol = 2)+
  ylab("Mean ratio of YE to halibut within cells") +
  xlab("Number of cells in average (selected in order of decreasing halibut abundance)") + 
  # xlab("Proportion of cells with highest Halibut abundance ()") + 
  theme(legend.position = c(0.65, 0.1))

ggsave("figs/expected_YE_when_maximizing_hal.png", width = 7, height = 9)
...
ggplot() + 
  ...
  geom_line(data = top_cell_increments, 
    aes(      
      ...
      colour = "red"), size = 1,
    inherit.aes = FALSE) +
  coord_cartesian(expand = F,  #xlim = c(0, 0.5), 
    ylim = c(0, 70)) +
  scale_color_identity(name = "Area",
                          breaks = c("darkblue", "red"),
                          labels = c("3CD (non-CDA)", "CDA"),
  ...
  xlab("Number of cells in average (selected in order of decreasing halibut abundance)") + #(proportion of total CDA cells)
  theme(legend.position = c(0.65, 0.1))

ggsave("figs/expected_halibut_when_maximizing_hal.png", width = 7, height = 9)
```


### What about ordered to minimize yelloweye?
```{r}
p_hal_cda <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-cda.rds")
p_ye_cda <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-cda.rds")
...
p_hal_5A <- readRDS("data-generated/hybrid-halibut-trawlinhbllyrs-paired-predictions-5A.rds")
p_ye_5A <- readRDS("data-generated/hybrid-yelloweye-trawlinhbllyrs-paired-predictions-5A.rds")
...
ratio_5A <- left_join(py_5A, ph_5A) %>% mutate(
  halibut = exp(hal_est)* (100 * 0.0024384 * 0.009144 * 10000)*1.33 , # convert kg/ha to kg/100 hooks
  yelloweye = exp(ye_est)* (100 * 0.0024384 * 0.009144 * 10000), # convert kg/ha to kg/100 hooks
  ye_per_hal = yelloweye / halibut, hal_per_ye = halibut / yelloweye
)
...
avoiding_cda <- ratio_cda[order(ratio_cda$yelloweye, decreasing = F), ] %>% group_by(year) %>% 
  mutate(ordered = 1:n(), 
    hal_cumsum = cumsum(halibut), 
    ye_cumsum = cumsum(yelloweye),
    cumsum_ye_hal = ye_cumsum/hal_cumsum,
    cumsum_hal_ye = hal_cumsum/ye_cumsum,
    mean_ratio = (ye_cumsum/ordered)/(hal_cumsum/ordered),
    mean_hal_ratio = (hal_cumsum/ordered)/(ye_cumsum/ordered),
    proportion = ordered/nrow(cda_2020)
    ) %>% ungroup()

avoiding_noncda <- ratio_noncda[order(ratio_noncda$yelloweye, decreasing = F), ] %>% group_by(year) %>% 
  mutate(ordered = 1:n(),
    hal_cumsum = cumsum(halibut), 
    ye_cumsum = cumsum(yelloweye),
    cumsum_ye_hal = ye_cumsum/hal_cumsum,
...
avoiding_5A <- ratio_5A[order(ratio_5A$yelloweye, decreasing = F), ] %>% group_by(year) %>% 
  mutate(ordered = 1:n(), 
    hal_cumsum = cumsum(halibut), 
    ye_cumsum = cumsum(yelloweye),
    cumsum_ye_hal = ye_cumsum/hal_cumsum,
...
ggplot() + 
  geom_line(data = avoiding_noncda %>% 
  filter(ordered %in% c( 
    round((nrow(cda_2020))*.01), 
    ...
    aes(
      x = ordered, # x = proportion, 
      y = mean_hal_ratio, #lty = "solid", 
      colour = "darkblue"), size = 1) +
  geom_line(data = avoiding_cda %>% 
  filter(ordered %in% c( 
    round((nrow(cda_2020))*.01), 
    round((nrow(cda_2020))*.02), round((nrow(cda_2020))*.03), round((nrow(cda_2020))*.04),
    round((nrow(cda_2020))*.05), round((nrow(cda_2020))*.1), round((nrow(cda_2020))*.2)
    ...
    aes(x = ordered, # x = proportion, 
      y = mean_hal_ratio, #lty = "solid", 
      colour = "red"), size = 1,
    inherit.aes = FALSE) +
  geom_line(data = avoiding_5A %>% 
  filter(ordered %in% c( 
    round((nrow(cda_2020))*.01), 
    round((nrow(cda_2020))*.02), round((nrow(cda_2020))*.03), round((nrow(cda_2020))*.04),
    round((nrow(cda_2020))*.05), round((nrow(cda_2020))*.1), round((nrow(cda_2020))*.2)
...
# ) +
  scale_color_identity(name = "Area",
                          breaks = c("green","darkblue", "red"),
                          labels = c("5A", "3CD (non-CDA)", "CDA"),
                          guide = "legend") +
  facet_wrap(~year, ncol = 2)+
  ylab("Mean ratio of halibut to YE") +
  xlab("Number of cells in average (selected to minimize YE)") +
  theme(legend.position = c(0.65, 0.1))


ggsave("figs/expected_halibut_when_avoiding_YE.png", width = 7, height = 9)
```
...
#     # xlim = c(0, nrow(cda_2020)/2),
  ...
  xlab("Number of cells in average (selected to minimize YE)") + #in order of increasing YE abundance
  theme(legend.position = c(0.65, 0.1))

ggsave("figs/expected_YE_when_avoiding_YE.png", width = 7, height = 6)
```
...
ggsave("cummulative-catch-rates-x.png", width = 7, height = 9)
```
...
ggsave("expected_YE.png", width = 6.5, height = 4)
```
